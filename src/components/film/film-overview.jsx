          ...
          <div className="movie-card__info">
            ...
            <div className="movie-card__desc">
              ...
              <div className="movie-card__text">
                ...
                <p className="movie-card__director"><strong>Director: {films[id].director}</strong></p>

                <p className="movie-card__starring"><strong>Starring: {films[id].starring.join(`, `)}</strong></p>
              </div>
            </div>
          </div>
        </div>
